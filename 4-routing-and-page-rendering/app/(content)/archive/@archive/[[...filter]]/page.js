...
async function FilterHeader({ year, month }) {
  console.log("🚀 ~ page.js:13 ~ FilterHeader ~ year:", year);
...
async function FilteredNews({ year, month }) {
  console.log("🚀 ~ page.js:51 ~ FilteredNews ~ year:", year);
  let news;
...
export default async function FilteredNewsPage({ params }) {
  ...
  console.log("🚀 ~ page.js:75 ~ FilteredNewsPage ~ selectedYear:", selectedYear);
